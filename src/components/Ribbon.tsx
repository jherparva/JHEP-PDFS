...
import { 
  ...
  LayoutGrid, Layers, Download, FileUp, Settings2, BookOpen, MonitorDown, FileSearch
} from "lucide-react";
...
const actionGroups = [
  {
    ...
    tools: [
      ...
      { id: "searchNumber", label: "Buscar N°", icon: FileSearch, color: "text-indigo-600", bg: "bg-indigo-50" },
...
export const Ribbon = ({ onAction, activeTab, isFoliating, canInstall, onInstall }: RibbonProps) => {
  return (
    <>
      {/* =========================================================================
           VERSION DESKTOP (ORIGINAL VERCEL - OPTIMIZADA)
         ========================================================================= */}
